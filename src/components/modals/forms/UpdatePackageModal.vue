<template>
  <div
    class="modal fade"
    id="kt_modal_update_package"
    ref="updatePackageModalRef"
    tabindex="-1"
    aria-hidden="true"
  >
    <div class="modal-dialog modal-dialog-centered mw-650px">
      <div class="modal-content">
        ...
        <div class="modal-header" id="kt_modal_update_package_header">
          <h2 class="fw-bold">{{ $t("updatePackage") }}</h2>
          <button
            id="kt_modal_update_package_close"
        ...
        >
          ...
          <div class="modal-body py-10 px-lg-17">
            <div
              ...
              id="kt_modal_update_package_scroll"
            >
              <!-- Name in Arabic -->
  ...
  formRef.value.validate(async (valid) => {
    if (valid) {
      ...
      const { data } = await useFetch(
        `${import.meta.env.VITE_APP_API_URL_MEGATRON}/packages/${id.value}`,
        {
          method: "PUT",
      ...
      if (data.value?.status) {
        ...
        resetForm();
        loading.value = false;
        hideModal("#kt_modal_update_package");
      }
    }
  });
};
...
watch(
  ...
  (newPackage) => {
    if (newPackage) {
      formData.value = {
        name: { ar: newPackage.name.ar, en: newPackage.name.en },
        description: {
          ar: newPackage.description.ar,
          en: newPackage.description.en,
        },
        durations: newPackage.durations || [
          { duration_months: "", points: "" },
        ],
      };
      id.value = newPackage.id;
    } else {
      resetForm();
    }
  },
